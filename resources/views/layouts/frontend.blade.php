            ...
            <div class="container-fluid">
                <div class="furniture-bottom-wrapper">
                    ...
                    <div class="furniture-search">
                        <form>
                            <input placeholder="Mau Cari Apa ? " type="text" name="q" autocomplete="off" id="search">
                            <button disabled>
                                <i class="ti-search"></i>
                            </button>
                        </form>
                    ...
                    <div class="furniture-wishlist">
                        <ul>
                            <li>
                                <a href="{{ route('favorite.index') }}"><i class="ti-heart"></i> Wishlist</a>
                            </li>
                            @auth
                            <li>
                    ...
                    <div class="footer-widget mb-30">
                        ...
                        <div class="footer-info-wrapper-3">
                            ...
                            <div class="footer-address-furniture">
                                ...
                                <div class="footer-info-content3">
                                    <p><a href="#"> cs@alkeslogy.id</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="footer-widget mb-30">
                        <h3 class="footer-widget-title-5">Buletin</h3>
                        <div class="footer-newsletter-2">
                            <p>Kritik dan Saran Silahkan Hubungi Kami</p>
                            <div id="mc_embed_signup" class="subscribe-form-5">
                                <form action="http://devitems.us11.list-manage.com/subscribe/post?u=6bbb9b6f5827bd842d9640c82&amp;id=05d85f18ef" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                                    <div id="mc_embed_signup_scroll" class="mc-form">
                                        <input type="email" value="" name="EMAIL" class="email" placeholder="Alamat Email Anda" required>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="copyright-furniture">
                            <p>Copyright Kelompok 1 RPL D © 2022 . All Right Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
